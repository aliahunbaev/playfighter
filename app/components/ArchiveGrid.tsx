...
export default function ArchiveGrid({ postsByDay, totalDays }: ArchiveGridProps) {
  ...
  return (
    <>
      <div className="max-w-4xl mx-auto mb-4">
        <div className="grid gap-[3px] md:gap-[2px]" style={{ gridTemplateColumns: 'repeat(50, minmax(0, 1fr))' }}>
